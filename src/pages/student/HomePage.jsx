...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      <header className="bg-clay-950 text-white sticky top-0 z-20 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <Link
            to="/check-booking"
            className="text-sm text-clay-200 hover:text-white transition px-3 py-2 rounded-lg hover:bg-clay-900"
          >
            Check Booking
          </Link>
        </div>
...
<section className="max-w-5xl mx-auto px-4 py-10 sm:py-20 text-center">
        <h1 className="text-3xl sm:text-5xl font-extrabold text-stone-900 tracking-tight leading-tight">
          HOSTEL <span className="text-clay-600">BOOKING</span>
        </h1>
        <p className="mt-3 sm:mt-4 text-base sm:text-lg text-stone-600 max-w-xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 mt-6 sm:mt-8">
          ...
          <Link
            to="/check-booking"
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-white text-clay-600 font-semibold rounded-xl border-2 border-clay-200 hover:border-clay-400 hover:bg-clay-50 transition-all duration-200"
          >
      ...
      <section className="max-w-5xl mx-auto px-4 pb-14">
        <h2 className="text-xl sm:text-2xl font-bold text-stone-900 text-center mb-6 sm:mb-8">
        ...
        {loading ? (
          ...
          <p className="text-center text-stone-500 py-12">No accommodation types available yet.</p>
        ) : (
            ...
            {accommodations.map((acc) => (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-stone-800">{acc.name}</h3>
                </div>
                {acc.description && (
                  <p className="text-sm text-stone-500 mb-4">{acc.description}</p>
                )}
      ...
      <section className="bg-white border-y border-stone-200">
        <div className="max-w-5xl mx-auto px-4 py-12 sm:py-16">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 text-center mb-8 sm:mb-10">
            How It Works
          </h2>
      ...
      <section className="max-w-5xl mx-auto px-4 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
          <div className="flex flex-col items-center gap-2 p-4">
            ...
            <span className="text-sm text-stone-500">+254 700 000 000</span>
          </div>
          <div className="flex flex-col items-center gap-2 p-4">
            <div className="w-12 h-12 rounded-full bg-clay-100 flex items-center justify-center">
            ...
            <span className="text-sm text-stone-500">hostels@university.ac.ke</span>
          </div>
          <div className="flex flex-col items-center gap-2 p-4">
            <div className="w-12 h-12 rounded-full bg-clay-100 flex items-center justify-center">
            ...
            <span className="text-sm text-stone-500">Student Affairs Office</span>
          </div>
        </div>
      </section>

      <footer className="bg-clay-950 text-stone-300 py-8">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            <Bed className="w-5 h-5 text-clay-400" />
            <span className="font-semibold text-white">Hostel Management System</span>
          </div>
          <p className="text-xs text-stone-400">&copy; {new Date().getFullYear()} Hostel Booking System. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
...
function StepCard({ step, icon: Icon, title, description }) {
  return (
    <div className="text-center">
      <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-clay-100 mb-4">
        <Icon className="w-7 h-7 text-clay-600" />
      </div>
      <div className="text-xs font-bold text-clay-400 mb-1">Step {step}</div>
